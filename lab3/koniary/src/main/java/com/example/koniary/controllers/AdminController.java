...
public class AdminController {
    ...
    private void loadDummyData() {
        ...
        Stable s1 = new Stable("Kraków Stable", 10);
        Stable s2 = new Stable("Warsaw Stable", 5);

        s1.addHorse(new Horse("Max", "Arabian", HorseType.HOT_BLOODED,
                HorseCondition.HEALTHY, 4, 5000, 450));

        s1.addHorse(new Horse("Bella", "Mustang", HorseType.COLD_BLOODED,
                HorseCondition.SICK, 7, 3200, 520));

        stables.addAll(s1, s2);
    }
